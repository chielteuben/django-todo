...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('todo_category', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=40)),
            ('slug', self.gf('django.db.models.fields.SlugField')(max_length=40, db_index=True)),
            ('enabled', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal('todo', ['Category'])

        # Adding field 'Item.category'
        db.add_column('todo_item', 'category', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['todo.Category'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'Category'
        db.delete_table('todo_category')

        # Deleting field 'Item.category'
        db.delete_column('todo_item', 'category_id')
