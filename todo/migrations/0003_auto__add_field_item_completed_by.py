...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Item.completed_by'
        db.add_column('todo_item', 'completed_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='completed_by', null=True, to=orm['auth.User']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Item.completed_by'
        db.delete_column('todo_item', 'completed_by_id')
